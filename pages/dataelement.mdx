...
This MDX documentation provides a comprehensive description of your `GET /api/v1/data-element` API, detailing the query parameters, responses, and error handling. Let me know if you want to adjust or add anything!
